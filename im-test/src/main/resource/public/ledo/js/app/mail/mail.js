...
app.controller('MailCtrl', ['$scope','$http','$state','$rootScope','ChatService', function($scope,$http,$state,ChatService,$rootScope) {
  $scope.folds = [
    {name: 'Inbox', filter:''},
...
//  var channel = '/user/'+ $rootScope.user.id+'/chat/message';
